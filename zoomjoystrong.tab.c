...
#line 3 "zoomjoystrong.y" /* yacc.c:339  */
...
union YYSTYPE
{
#line 36 "zoomjoystrong.y" /* yacc.c:355  */
char* str; int i; float f; 
...
static const char *const yytname[] =
{
  ...
  "zoomjoystrong", "list", "zjs", "point", "line", "circle", "rectangle",
...
#line 81 "zoomjoystrong.y" /* yacc.c:1646  */
    {printf("%s %d %d;\n", (yyvsp[-3].str), (yyvsp[-2].i), (yyvsp[-1].i)); plotPoint((yyvsp[-2].i),(yyvsp[-1].i));}
#line 1252 "zoomjoystrong.tab.c" /* yacc.c:1646  */
    break;

  case 11:
#line 85 "zoomjoystrong.y" /* yacc.c:1646  */
    {printf("%s %d %d %d %d;\n", (yyvsp[-5].str), (yyvsp[-4].i), (yyvsp[-3].i), (yyvsp[-2].i), (yyvsp[-1].i)); plotLine((yyvsp[-4].i), (yyvsp[-3].i), (yyvsp[-2].i), (yyvsp[-1].i));}
#line 1258 "zoomjoystrong.tab.c" /* yacc.c:1646  */
    break;

  case 12:
#line 89 "zoomjoystrong.y" /* yacc.c:1646  */
    {printf("%s %d %d %d;\n", (yyvsp[-4].str), (yyvsp[-3].i), (yyvsp[-2].i), (yyvsp[-1].i)); plotCircle((yyvsp[-3].i), (yyvsp[-2].i), (yyvsp[-1].i));}
#line 1264 "zoomjoystrong.tab.c" /* yacc.c:1646  */
    break;

  case 13:
#line 93 "zoomjoystrong.y" /* yacc.c:1646  */
    {printf("%s %d %d %d %d;\n", (yyvsp[-5].str), (yyvsp[-4].i), (yyvsp[-3].i), (yyvsp[-2].i), (yyvsp[-1].i)); drawRectangle((yyvsp[-4].i), (yyvsp[-3].i), (yyvsp[-2].i), (yyvsp[-1].i));}
#line 1270 "zoomjoystrong.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 97 "zoomjoystrong.y" /* yacc.c:1646  */
    {printf("%s %d %d %d;\n", (yyvsp[-4].str), (yyvsp[-3].i), (yyvsp[-2].i), (yyvsp[-1].i)); setColor((yyvsp[-3].i), (yyvsp[-2].i), (yyvsp[-1].i));}
#line 1276 "zoomjoystrong.tab.c" /* yacc.c:1646  */
    break;

  case 15:
#line 101 "zoomjoystrong.y" /* yacc.c:1646  */
    {printf("%s;\n", (yyvsp[-1].str)); finish(); return 0;}
